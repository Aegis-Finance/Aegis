...
/**
 * @title GovernanceVerifierWrapper
 * @dev Factory-based wrapper for governance ZK proof verification
 ...
 */
contract GovernanceVerifierWrapper is IFactoryVerifierWrapper {
    ...
    string public constant CIRCUIT_TYPE = "governance";
    
    /// @dev Function selector for verifyProof to avoid long string
