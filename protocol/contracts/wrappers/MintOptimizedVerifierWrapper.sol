...
/**
 * @title MintOptimizedVerifierWrapper
 * @dev Factory-based wrapper for mint-optimized ZK proof verification
 ...
 */
contract MintOptimizedVerifierWrapper is IFactoryVerifierWrapper {
    ...
    string public constant CIRCUIT_TYPE = "mint-optimized";
    
    /// @dev Function selector for verifyProof to optimize gas usage
