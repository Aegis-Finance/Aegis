...
/**
 * @title PrivacyVerifierWrapper
 * @dev Factory-based wrapper for privacy ZK proof verification
 ...
 */
contract PrivacyVerifierWrapper is IFactoryVerifierWrapper {
    ...
    string public constant CIRCUIT_TYPE = "privacy";
