...
/**
 * @title BridgeVerifierWrapper
 * @dev Factory-based wrapper for bridge ZK proof verification
 ...
 */
contract BridgeVerifierWrapper is IFactoryVerifierWrapper {
    /// @notice Immutable factory reference for gas optimization
    /// @dev Stores the VerifierFactory contract address
    VerifierFactory public immutable VERIFIER_FACTORY;
    
    /// @notice Circuit type constant for this wrapper
    /// @dev Defines the specific circuit type this wrapper handles
    string public constant CIRCUIT_TYPE = "bridge";
