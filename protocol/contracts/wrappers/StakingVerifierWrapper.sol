...
/**
 * @title StakingVerifierWrapper
 * @dev Factory-based wrapper for staking ZK proof verification
 ...
 */
contract StakingVerifierWrapper is IFactoryVerifierWrapper {
    ...
    string public constant CIRCUIT_TYPE = "staking";
