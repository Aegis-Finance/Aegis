 ...
 * @dev ZK circuit for private reward claims
 * @notice Proves reward eligibility and amount without revealing recipient identity
 */
template Reward() {
    // Public inputs
    ...
    commitmentHasher.inputs[1] <== rewardAmount;
...
component main {public [nullifierHash, commitmentHash, merkleRoot, rewardAmount, epoch]} = Reward();
