...
/**
 * @title Staking Circuit
 * @dev ZK circuit for private staking operations
 * @notice Proves staking commitment and amount without revealing staker identity
 */
template Staking() {
    // Public inputs
...
component main {public [nullifierHash, commitmentHash, merkleRoot, amount, epoch]} = Staking();
