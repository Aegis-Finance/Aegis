 ...
 * @dev ZK circuit for private leaderboard submissions
 * @notice Proves leaderboard score without revealing participant identity
 */
template Leaderboard() {
    ...
    commitmentHasher.inputs[1] <== score;
    commitmentHasher.inputs[2] <== cycleId;
...
component main {public [nullifierHash, commitmentHash, merkleRoot, score, cycleId]} = Leaderboard();
