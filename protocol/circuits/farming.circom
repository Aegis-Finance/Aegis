...
/**
 * @title Farming Circuit
 * @dev ZK circuit for private yield farming operations
 * @notice Proves farming position and reward claims without revealing farmer identity
 */
template Farming() {
    // Public inputs
    ...
    commitmentHasher.inputs[2] <== poolId;
...
component main {public [nullifierHash, commitmentHash, merkleRoot, amount, poolId]} = Farming();
